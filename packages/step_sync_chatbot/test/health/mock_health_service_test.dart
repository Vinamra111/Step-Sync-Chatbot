...
void main() {
  group('MockHealthService', () {
    ...
    test('initializes successfully', () async {
      ...
      // On non-mobile platforms, manually add mock sources for testing
      healthService.mockDataSources = [
        DataSource(id: 'test.source', name: 'Test Source'),
      ];
    ...
    test('gets data sources', () async {
      ...
      // On non-mobile platforms, manually add mock sources for testing
      healthService.mockDataSources = [
        DataSource(id: 'test.source1', name: 'Test Source 1'),
        DataSource(id: 'test.source2', name: 'Test Source 2'),
      ];

...
final _intentPatterns = [
  ...
  // Wrong step count - adjective before noun
  _IntentPattern(
  ...
  // Wrong step count - noun before adjective (e.g., "my steps are incorrect")
  _IntentPattern(
    regex: RegExp(r'\b(steps?|step count|count).*(wrong|incorrect|different|off)\b'),
    intent: UserIntent.wrongStepCount,
    confidence: 0.90,
  ),
  ...
  // Duplicate steps
  _IntentPattern(
    regex: RegExp(r'\b(duplicate|double|twice).*(steps?|count)\b'),
    intent: UserIntent.duplicateSteps,
    confidence: 0.88,
  ),

  // Data missing - adjective before noun
  _IntentPattern(
  ...
  // Data missing - noun before adjective (e.g., "my data is missing")
  _IntentPattern(
    regex: RegExp(r'\b(data|steps?).*(missing|lost|disappeared)\b'),
    intent: UserIntent.dataMissing,
    confidence: 0.88,
  ),

...
mixin _$ChatBotState {
  ...
  String? get streamingMessageContent => throw _privateConstructorUsedError;
...
class _$ChatBotStateCopyWithImpl<$Res, $Val extends ChatBotState>
  ...
  $Res call({
    ...
    Object? streamingMessageContent = freezed,
    ...
    return _then(_value.copyWith(
      ...
      isStreaming: null == isStreaming
          ...
          : isStreaming // ignore: cast_nullable_to_non_nullable
              as bool,
      streamingMessageContent: freezed == streamingMessageContent
          ? _value.streamingMessageContent
          : streamingMessageContent // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$ChatBotStateImpl implements _ChatBotState {
  ...
  @override
  String toString() {
    return 'ChatBotState(messages: $messages, status: $status, permissionState: $permissionState, dataSources: $dataSources, recentStepData: $recentStepData, isTyping: $isTyping, isStreaming: $isStreaming, streamingMessageContent: $streamingMessageContent, streamingMessageId: $streamingMessageId, errorMessage: $errorMessage, userContext: $userContext)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(
                    other.streamingMessageContent, streamingMessageContent) ||
                other.streamingMessageContent == streamingMessageContent) &&
...
abstract class _ChatBotState implements ChatBotState {
  ...
  /// Content of the message currently being streamed (partial text).
  String? get streamingMessageContent;
  @override
